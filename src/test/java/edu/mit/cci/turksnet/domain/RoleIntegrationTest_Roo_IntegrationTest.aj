...
privileged aspect RoleIntegrationTest_Roo_IntegrationTest {
    ...
    public void RoleIntegrationTest.testCountRoles() {
        ...
        long count = edu.mit.cci.turksnet.domain.Role.countRoles();
    ...
    public void RoleIntegrationTest.testFindRole() {
        edu.mit.cci.turksnet.domain.Role obj = dod.getRandomRole();
        ...
        obj = edu.mit.cci.turksnet.domain.Role.findRole(id);
    ...
    public void RoleIntegrationTest.testFindAllRoles() {
        ...
        java.util.List<edu.mit.cci.turksnet.domain.Role> result = edu.mit.cci.turksnet.domain.Role.findAllRoles();
    ...
    public void RoleIntegrationTest.testFindRoleEntries() {
        ...
        java.util.List<edu.mit.cci.turksnet.domain.Role> result = edu.mit.cci.turksnet.domain.Role.findRoleEntries(0, (int) count);
    ...
    public void RoleIntegrationTest.testMerge() {
        ...
        boolean modified =  dod.modifyRole(obj);
        java.lang.Integer currentVersion = obj.getVersion();
        edu.mit.cci.turksnet.domain.Role merged = (edu.mit.cci.turksnet.domain.Role) obj.merge();
        obj.flush();
    ...
    public void RoleIntegrationTest.testPersist() {
        org.junit.Assert.assertNotNull("Data on demand for 'Role' failed to initialize correctly", dod.getRandomRole());
        edu.mit.cci.turksnet.domain.Role obj = dod.getNewTransientRole(Integer.MAX_VALUE);
    ...
    public void RoleIntegrationTest.testRemove() {
        ...
        obj.remove();
        obj.flush();
        org.junit.Assert.assertNull("Failed to remove 'Role' with identifier '" + id + "'", edu.mit.cci.turksnet.domain.Role.findRole(id));
    }
