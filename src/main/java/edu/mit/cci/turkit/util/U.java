...
*/
    ...
    public static Map<? extends String, ? extends String> splitProperties(String s, String props) {
        Map<String,String> result = new HashMap<String, String>();
        if (props == null || props.isEmpty()) {
           return result;
        }
        for (String frag:props.split(s)) {
            if (frag.startsWith("#") || frag.trim().isEmpty()) continue;
            String[] kv = frag.split("=",2);
     ...
     public static Map<? extends String, ? extends String> splitProperties(String props) {
