...
MTurk.prototype.createHITRaw = function(params) {
	...
	if(typeOf(params.qualificationRequirements) == "object"){
		...
		params.qualificationRequirements.push(temp);
    ...
    //add auto approval delay if set
    XMLstring = XMLstring + (params.autoApprovalDelayInSeconds? XMLstringFromObjs(params.autoApprovalDelayInSeconds,"AutoApprovalDelayInSeconds"):"")
